  ...
  return (
    <>
      <section className="flex flex-col justify-center items-center md:mt-10">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 col-start lg:px-40 lg:py-8 px-2 py-10 md:px-8 md:py-4 gap-10 md:gap-10 lg:gap-20">
          <div className="lg:border-r-2  border-gray-300 flex flex-col items-center space-y-4">
            ...
            <div className="flex lg:space-x-4 lg:mr-20">
              ...
              <div>
                <p className="text-black font-medium">Jafar Andishmand</p>
          ...
          <div className="text-gray-800 flex flex-col items-center space-y-4 justify-center">
